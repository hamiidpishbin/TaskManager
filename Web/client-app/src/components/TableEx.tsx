...
// import { TableData } from "../models/table/TableData";
...
// function BaseTableToolbar(props: BaseTableToolbarProps) {
...
//   headCells: HeadCell[];
//   rows: SprintTableData[];
// }

// export default function BaseTable({ headCells, rows }: BaseTableProps) {
//   const [order, setOrder] = React.useState<Order>("asc");
//   const [orderBy, setOrderBy] = React.useState<string>(rows[0].startDate);
...
//     () =>
//       stableSort<SprintTableData>(rows, getComparator(order, orderBy)).slice(
//         page * rowsPerPage,
